...
# print 'date, rev1, rev2, nAdded, totalAdded, meanAdded, nRemoved,
# totalRemoved, meanRemoved, totalDelta, meanDelta'
...
def parse_complexity_delta_in(file_name, revision_range):
    ...
    for i in range(len(revs) - 1):
        ...
        complexity_in_one_rev = parse_complexity_changes_in(
            first_revision, git_diff)
...
def run(args):
    ...
    complexity_delta_in_revs = parse_complexity_delta_in(
        args.file, revision_range)
